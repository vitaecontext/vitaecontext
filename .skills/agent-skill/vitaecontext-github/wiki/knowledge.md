...
Shared taxonomy: [vitaecontext/wiki/vitaecontext.md](../../vitaecontext/wiki/vitaecontext.md). Source grounding: [repository source inventory](https://github.com/vitaecontext/vitaecontext/blob/main/hub/github/sources.md).
