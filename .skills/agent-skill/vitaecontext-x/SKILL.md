...
- If the account strategy depends on professional facts or cross-platform consistency, recommend creating or updating the Career Context file first.
...
Human playbook: [X and Twitter optimization](https://vitaecontext.github.io/playbooks/x-twitter/).
